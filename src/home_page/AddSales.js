...
{props.showAddData && (
  <div>
    ...
    <p className='ipText'> SevvanthiYellow :
      ...
      {sevvanthiYellow * sevvanthiYellowPrice}
    </p>
    ...
    <p className='ipText'> SevvanthiWhite :
      ...
      {sevvanthiWhite * sevvanthiWhitePrice}
    </p>
    ...
    <p className='ipText' style={{ justifyContent: 'center' }}> Outstanding :
      <InputText readOnly={true} value={outStanding + (outstandingValue !== 0 && outstandingValue) - (collection !== 0 && collection)} />
    </p>

    <p className='ipText' style={{ justifyContent: 'center' }}> Total sales :
      <InputText readOnly={true} value={outstandingValue} />
    </p>

    <button onClick={() => { setDate(props.date); saveSalesData() }}>Save</button>
    <button onClick={() => clearPayLoad()}>Clear</button>
  </div>
)}
